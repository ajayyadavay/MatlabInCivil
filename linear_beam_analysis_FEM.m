function linear_beam_analysis_FEM(node,E,I,l,Support,Applied_Force)
    ...
    % node = 3; E = [2*10^8 2*10^8]; I = [5*10^-6 5*10^-6]; l = [3 3]; Support = ["Fixed"; "Roller"; "No_Support"]; Applied_Force = [0;0;0;0;15;40]
    % Example2: put the following data and you will get reaction-
    % node = 3; E = [20*10^8 20*10^8]; I = [5*10^-6 5*10^-6]; l = [8 6]; Support = ["Fixed"; "Roller"; "Roller"]; Applied_Force = [-20.51;-35.156;-69.49;-78.906;-60;60]
    % Example3: put the following data and you will get reaction-
    % node = 3; E = [1 1]; I = [1 1]; l = [5 5]; Support = ["Fixed"; "No_Support"; "Roller"]; Applied_Force = [0;0;-100;0;0;41.667]
   ...
   for i = 1:node
        if(Support(i,1) == "Roller")
               BC(2*i,1) = 1;
        elseif(Support(i,1) == "No_Support")
            BC(2*i-1,1) = 1;
            BC(2*i,1) = 1;
        end
   end
